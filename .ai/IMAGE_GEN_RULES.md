...
### Еда (food)
- Белая студия `#FFFFFF`; тарелка / бокс / пергамент — ок
- Тот же белый фон и свет, **без** текста/лого/бейджей веса
- Референс продукта (не UI сайта): Double Double — пергамент+цветная завязка; Sensorica — чиабатта/круассаны с начинкой, салаты, тост-сэндвичи, тортилья-роллы (разрез по диагонали), горячее как шницель/паста/рис
- Не копировать тёмный UI Sensorica и фиолетовый фон doubledouble.ru
